import {
  $TSAny, AmplifyException, AmplifyExceptionType, AmplifyFault, AmplifyFaultType, executeHooks, HooksMeta,
...
const printHeadlessAmplifyException = (amplifyException: AmplifyException): void => {
  ...
  errorPrinter.error(JSON.stringify(amplifyException.toObject(), null, 2));
};
